            ...
            <div className="flex flex-col w-full h-full">
                ...
                <div className=" rounded-lg h-[450px] md:h-screen flex flex-col pt-5 overflow-auto px-4 md:mb-5">
                    ...
                    {text===false && <div className="text-center">
                        ...
                        <h1 className="text-2xl mt-3 font-semibold ml-5">आज मैं आपकी मदद करने में कैसे सक्षम हूं?</h1>
                        <div className="flex justify-center mt-28">
                            <div className="block mx-10"><button onClick={()=>{setInput("विदेश अध्ययन")}} className="block px-24 py-3 border-2 rounded-2xl my-3">विदेश अध्ययन</button><button onClick={()=>{setInput("परामर्श मार्गदर्शन")}} className="block px-[88px] py-3 border-2 rounded-2xl">परामर्श मार्गदर्शन</button></div>
                            <div className="mx-10"><button onClick={()=>{setInput("निजी क्षेत्र की नौकरियाँ")}} className="block px-20 py-3 border-2 my-3 rounded-2xl">निजी क्षेत्र की नौकरियाँ</button><button onClick={()=>{setInput("सरकारी नौकरी")}}  className="block px-[102px] py-3 border-2 rounded-2xl">सरकारी नौकरी</button></div>
                        </div>
                    </div>}
                    {error && (
                        <div
