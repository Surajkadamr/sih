            ...
            <div className="flex flex-col w-full h-full">
                ...
                <div className=" rounded-lg h-[450px] md:h-screen flex flex-col pt-5 overflow-auto px-4 md:mb-5">
                    ...
                    {text === false && <div className="text-center">
                        ...
                        <h1 className="text-2xl mt-3 font-semibold ml-5">ਅੱਜ ਮੈਂ ਤੁਹਾਡੀ ਮਦਦ ਕਿਵੇਂ ਕਰ ਸਕਦਾ ਹਾਂ?</h1>
                        <div className="flex justify-center mt-28">
                            <div className="block mx-10"><button onClick={() => { setInput("ਵਿਦੇਸ਼ ਦਾ ਅਧਿਐਨ") }} className="block px-24 py-3 border-2 rounded-2xl my-3">ਵਿਦੇਸ਼ ਦਾ ਅਧਿਐਨ</button><button onClick={() => { setInput("ਸਲਾਹ ਮਾਰਗਦਰਸ਼ਨ") }} className="block px-[88px] py-3 border-2 rounded-2xl">ਸਲਾਹ ਮਾਰਗਦਰਸ਼ਨ</button></div>
                            <div className="mx-10"><button onClick={() => { setInput("ਪ੍ਰਾਈਵੇਟ ਸੈਕਟਰ ਦੀਆਂ ਨੌਕਰੀਆਂ") }} className="block px-20 py-3 border-2 my-3 rounded-2xl">ਪ੍ਰਾਈਵੇਟ ਸੈਕਟਰ ਦੀਆਂ ਨੌਕਰੀਆਂ</button><button onClick={() => { setInput("ਸਰਕਾਰੀ ਨੌਕਰੀ") }} className="block px-[130px] py-3 border-2 rounded-2xl">ਸਰਕਾਰੀ ਨੌਕਰੀ</button></div>
                        </div>
                    </div>}
                    {error && (
                        <div
